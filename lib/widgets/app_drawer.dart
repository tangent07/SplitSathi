...
class AppDrawer extends StatelessWidget {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: AppColors.orange.withOpacity(0.3), blurRadius: 15, offset: const Offset(0, 5))
                        ],
                      ),
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              child: (photoUrl == null || photoUrl.toString().isEmpty)
                                  ? const Icon(Icons.person, size: 30, color: AppColors.orange) 
                                  : null,
                            ),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  email.isNotEmpty ? email : 'Complete your profile',
                          ...
                          // NOTE: Chevron and Edit icon removed completely!
                        ],
                      ),
                    ),
                  ),

                  // 2. PROFESSIONAL FINTECH MENU ITEMS
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        _buildDrawerItem(
                          context: context, icon: Icons.person_outline_rounded, title: 'Profile', isDark: isDark,
                          onTap: () {
                            Navigator.pop(context);
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const ProfileScreen()));
                          },
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const SizedBox(width: 16),
                                const Text('Logout', style: TextStyle(color: Colors.redAccent, fontSize: 16, fontWeight: FontWeight.w700)),
                              ],
                            ),
                          ),
                        ),
  ...
  Widget _buildSectionHeader(String title, bool isDark) {
    return Padding(
      ...
      child: Text(
        title,
        style: TextStyle(color: Colors.grey.shade500, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.5),
      ),
    );
  }
  ...
  Widget _buildDrawerItem({
    ...
    return ListTile(
      ...
      trailing: Icon(Icons.chevron_right_rounded, color: Colors.grey.withOpacity(0.4), size: 18),
